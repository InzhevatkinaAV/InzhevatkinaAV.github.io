...
export function showHelpMessage(fields) {
	alert.innerHTML = '* Пожалуйста, заполните <b>обязательные поля</b>.<br>Помните, что забронировать интервал можно, если он завершится не менее чем через <b>10 минут</b> :)';
